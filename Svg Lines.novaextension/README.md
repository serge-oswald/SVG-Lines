...
<div id="tableBox">
  ...
  <details>
	<summary><span>Structure </span><span><svg viewBox="0 0 256 8"><rect x="0" width="128" height="8" fill="url(#eltpatt)"></rect><rect x="128" width="0" height="8" fill="url(#atrpatt)"></rect><rect x="128" width="0" height="8" fill="url(#xmppatt)"></rect></svg></span></summary>
