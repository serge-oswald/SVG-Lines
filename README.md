...
**[Panic Nova](https://nova.app) extension** including a set of svg clips, enabling you to play with Scalable Vector Graphics.

![svg lines header](https://www.servovalve.org/nova/img/svglines-header.svg)
 
 
 
 
...
| :-- | :-- | :-- | :-- | --:         |
| `1   ` | ![icon](https://www.servovalve.org/nova/img/cnt1.svg) | **STRUCTURE** | Svg header for file or inline html, structural elements. | `16 clips` |
| `2   ` | ![icon](https://www.servovalve.org/nova/img/cnt2.svg) | **SHAPES** | Primitives shapes, text, images. | `12 clips` |
| `3   ` | ![icon](https://www.servovalve.org/nova/img/cnt3.svg) | **STYLING** | Coloring, stroking, dashing, dotting. | `12 clips` |
| `4   ` | ![icon](https://www.servovalve.org/nova/img/cnt4.svg) | **TRANSFORM** | Translation, rotation, scale, skew. | `5 clips` |
| `5   ` | ![icon](https://www.servovalve.org/nova/img/cnt5.svg) | **ADVANCED** | Deeper styling with gradient, pattern, mask. | `23 clips` |
...
| `4   ` | ![icon](https://www.servovalve.org/nova/img/cnt4.svg) |  **TRANSFORM**  | | |
| `4.1 ` | → | **translate** |  | `vg-tran   ⇥` |
| `4.2 ` | → | **rotate** |  | `vg-trot   ⇥` |
| `4.3 ` | → | **scale** |  | `vg-tsca   ⇥` |
| `4.4 ` | → | **skewX** |  | `vg-tskx   ⇥` |
| `4.5 ` | → | **skewY** |  | `vg-tsky   ⇥` |
| `5   ` | ![icon](https://www.servovalve.org/nova/img/cnt5.svg) |  **ADVANCED**  | | |
