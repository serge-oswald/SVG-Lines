...
| `→   ` | ![icon](https://www.servovalve.org/nova/img/cnt0.svg) | **7** folders | **47** elements, **40** attributes, **4** examples. | `91 clips` |
...
→  Find a way to limit the action of this extension to php-html | html | xml | svg files. How to specify this with - syntax - ? 
